...
* Figs: Containing examples of how the figures should look like after 50.000 iterations
* mat: Containing saved model parameter outputs


The Matlab files: (Not necessary to know their functionalities in order to run the model)

* BHM_mainbody.m: The main file - the only file that is run by the user
...
The plots will be saved in the repository "Figs" in .m format. All parameters and plots that are saved after running the code will be overrun in the next run.
